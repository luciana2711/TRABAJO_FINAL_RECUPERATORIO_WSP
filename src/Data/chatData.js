const chatData = {
    'Rigby-RG': {
        ...
        avatarImgSrc: 'rigby.png', // Solo el nombre del archivo
        messages: [
    ...
    'Margarita-MG': {
        ...
        avatarImgSrc: 'Margarita.webp', // Solo el nombre del archivo
        messages: [
    ...
    'CJ-CJ': {
        ...
        avatarImgSrc: 'cj.jpg', // Solo el nombre del archivo
        messages: [
    ...
    'Musculoso-MC': {
        name: 'Musculoso',
        lastSeen: 'Últ. vez hoy a las 17:19',
        avatarImgSrc: 'musculoso.webp', // Solo el nombre del archivo
        messages: [
    ...
    'Benson-BN': {
        name: 'Benson',
        lastSeen: 'Últ. vez hoy a las 17:19',
        avatarImgSrc: 'benson.jpg', // Solo el nombre del archivo
        messages: [
    ...
    'Skips-SK': {
        name: 'Skips',
        lastSeen: 'Últ. vez hoy a las 17:19',
        avatarImgSrc: 'skip.jpeg', // Solo el nombre del archivo
        messages: [
    ...
    'Papaleta-PP': {
        name: 'Papaleta',
        lastSeen: 'Últ. vez hoy a las 17:19',
        avatarImgSrc: 'papaleta.jpg', // Solo el nombre del archivo
        messages: [
    ...
    'Grupo-rubios': {
        ...
        lastSeen: 'Últ. vez hoy a las 17:19',
        avatarImgSrc: 'images.jpeg', // Solo el nombre del archivo
        messages: [
